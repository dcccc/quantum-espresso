...
MODULE dft_setting_params
    ...
    !! set to TRUE.
    CHARACTER(LEN=100) :: lxc_exx_desc(7)
    ...
    ! short range exchange fraction 
    CHARACTER(LEN=100) :: lxc_exx_sr_desc(6)
    DATA lxc_exx_sr_desc / 'Fraction of short-range Hartree-Fock exchange', &
    ...
    ! long range exchange fraction 
    CHARACTER(LEN=100) :: lxc_exx_lr_desc(1)
    DATA lxc_exx_lr_desc / 'fraction of long-range HF exchange' /
