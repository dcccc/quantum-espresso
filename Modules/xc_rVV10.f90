...
!                                       |_____________|
  ...
  SUBROUTINE xc_rVV10(rho_valence, rho_core, nspin, etxc, vtxc, v, b_value_, C_value_)
    ...
    real(DP),optional,intent(in) :: C_value_
    ...
    if(present(C_value_)) C_value = C_value_   
    ! --------------------------------------------------------------------------------------------------------
