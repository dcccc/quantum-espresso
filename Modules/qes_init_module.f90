...
MODULE qes_init_module
  ...
  !
  !
  SUBROUTINE qes_init_hybrid(obj, tagname, qpoint_grid, ecutfock, exx_fraction, exx_fraction_lr, screening_parameter,&
    ...
    END IF
    IF ( PRESENT(exx_fraction_lr)) THEN
      obj%exx_fraction_lr_ispresent = .TRUE. 
      obj%exx_fraction_lr = exx_fraction_lr
    ELSE
